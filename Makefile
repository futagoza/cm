...
.PHONY:  all compile build prepare publish docs changes changelog readme clean
.SILENT: all compile build prepare publish docs changes changelog readme clean
